        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Installed Assets', translations: { es: 'Assets instalados' }, slug: 'installed-assets' },
            {
              ...
              collapsed: true,
              items: [
                { label: 'Codex (AGENTS.md)', translations: { es: 'Codex (AGENTS.md)' }, slug: 'codex-adapter' },
                { label: 'Claude Code (CLAUDE.md)', translations: { es: 'Claude Code (CLAUDE.md)' }, slug: 'claude-adapter' },
                { label: 'OpenCode (AGENTS.md)', translations: { es: 'OpenCode (AGENTS.md)' }, slug: 'opencode-adapter' },
                { label: 'Antigravity (AGENTS.md)', translations: { es: 'Antigravity (AGENTS.md)' }, slug: 'antigravity-adapter' },
                { label: 'Kiro (AGENTS.md)', translations: { es: 'Kiro (AGENTS.md)' }, slug: 'kiro-adapter' },
